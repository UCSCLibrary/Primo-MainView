...
if (true) {
  ...
  let alertBanner = window.setInterval(function(){
    ...
    if (prmAlertBar[0]) {
      ...
      alertBarInnerDiv.innerHTML = '<p>S&E Library lower level books are inaccessible September 22, 2021 - August 1, 2022. Please request items through UC Library Search. <a href="https://library.ucsc.edu/news/science-engineering-library-physical-collections-not-accessible-during-renovation" target="_blank">See more information</a>.</p><p>Proquest databases will be unavailable from 7:00pm Saturday, July 16 to 4:00am Sunday, July 17.</p>';
